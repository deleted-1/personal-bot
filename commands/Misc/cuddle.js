...
module.exports = {
    name: "cuddle",
    alias: ["cuddle"],
    description: "cuddle with a user :eyes:",
    ...
    run: async (client, msg, args) => {
        ...
        if(!user) return msg.reply('you have to mention the user you would like to cuddle. d\'oi.');

        await fetch('https://tenor.com/search/cuddle-anime-gifs')
            .then(async body => {
        ...
        let embed = new RichEmbed()
            ...
            .setDescription(`${msg.author} cuddles with ${user}`)
            .setImage(gif)
