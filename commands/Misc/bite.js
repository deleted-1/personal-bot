...
module.exports = {
    ...
    run: async (client, msg, args) => {
        ...
        if(!user) return msg.reply('you have to mention the user you would like to bite. d\'oi.');

        await fetch('https://tenor.com/search/anime-bite-gifs')
            .then(async body => {
        ...
        let embed = new RichEmbed()
            ...
            .setDescription(`${msg.author} bites ${user}`)
            .setImage(gif)
